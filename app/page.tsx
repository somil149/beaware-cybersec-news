...
const mockArticles = [
  {
    ...
    categoryId: '1',
    category: { id: '1', name: 'AI Security', slug: 'ai-security', description: 'AI security news and threats', createdAt: new Date(), updatedAt: new Date(), icon: null, parentId: null },
    sourceId: '1',
    source: { id: '1', name: 'Krebs on Security', url: 'https://krebsonsecurity.com/feed/', type: 'RSS' as const, credibilityScore: 0.9, lastFetched: new Date(), active: true, createdAt: new Date(), updatedAt: new Date() },
    sentimentScore: 0.3,
  ...
  },
  {
    ...
    categoryId: '2',
    category: { id: '2', name: 'AI Trends', slug: 'ai-trends', description: 'Latest AI industry trends', createdAt: new Date(), updatedAt: new Date(), icon: null, parentId: null },
    sourceId: '2',
    source: { id: '2', name: 'The Hacker News', url: 'https://thehackernews.com/feed.xml', type: 'RSS' as const, credibilityScore: 0.85, lastFetched: new Date(), active: true, createdAt: new Date(), updatedAt: new Date() },
    sentimentScore: 0.8,
  ...
  },
  {
    ...
    categoryId: '3',
    category: { id: '3', name: 'Cybersecurity', slug: 'cybersecurity', description: 'Cybersecurity news', createdAt: new Date(), updatedAt: new Date(), icon: null, parentId: null },
    sourceId: '3',
    source: { id: '3', name: 'Dark Reading', url: 'https://www.darkreading.com/rss.xml', type: 'RSS' as const, credibilityScore: 0.8, lastFetched: new Date(), active: true, createdAt: new Date(), updatedAt: new Date() },
    sentimentScore: -0.5,
